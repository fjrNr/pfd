...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('flight.png') }}" >

    <!-- Styles -->
    <link href="{{ asset('css/menu/app.css') }}" rel="stylesheet">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    @if(Auth::user()->group == 'ADMIN' || Auth::user()->group == 'USER X')
                                    <a class="dropdown-item" href="/submission/insert">
                                        Insert Submission
                                    </a>
                                    @endif
                                    @if(Auth::user()->group == 'ADMIN' || Auth::user()->group == 'USER')
